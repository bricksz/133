'''
Rerun the experiment of Program 10.0.2, but cut the number of encounters in each
generation from 2,000 to 500.
Observe the re sult and attempt to explain it.
[ Hint: On average, what percent of a player’s encounters will be with ‘strangers’, players it is
encountering for the first time?
Modify your program to report data relevant to this question.]
'''
