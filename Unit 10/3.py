'''
In a natural setting, individuals tend mostly to encounter neighbors rather than just
any other individual from the population. Rerun the last experiment in the ‘Learn
something new’ section, but restrict encounters to players at most three apart in the
allPlayers list. For example, the player at index 7 should only encounter players at
indices 4, 5, 6, 8, 9 or 10.
'''
